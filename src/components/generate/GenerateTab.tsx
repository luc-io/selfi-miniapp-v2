  ...
  return (
    <Card className="bg-card rounded-lg shadow-md">
      <div className="p-6 space-y-8">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-card-foreground">
              Steps <span className="text-muted-foreground">({params.num_inference_steps})</span>
            </label>
            <Slider 
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-card-foreground">
              Guidance Scale <span className="text-muted-foreground">({params.guidance_scale})</span>
            </label>
            <Slider 
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-card-foreground">
              Number of Images <span className="text-muted-foreground">({params.num_images})</span>
            </label>
            <Slider 
        ...
        {/* Save Button */}
        <button
          className="w-full py-3 px-4 bg-primary text-primary-foreground text-sm font-semibold rounded-lg shadow-sm hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-primary"
